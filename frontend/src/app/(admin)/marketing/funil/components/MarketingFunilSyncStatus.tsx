  ...
  return (
    <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm backdrop-blur">
      ...
      <div className="mt-3 space-y-2 text-xs text-slate-600">
        ...
        <div className="flex items-center justify-between gap-3">
          <span className="font-medium text-slate-500">CRM CRC</span>
          <span className="text-right text-slate-700">{formatDateTime(crmLastSyncAt)}</span>
        </div>
