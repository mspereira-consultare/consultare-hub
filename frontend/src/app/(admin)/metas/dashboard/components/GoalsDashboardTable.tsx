                ...
                >
                  ...
                  <td className="px-4 py-3 align-top">
                    <div className="min-w-[110px] space-y-2">
                      <div className="flex items-center justify-between gap-2">
                        <span className="font-semibold text-slate-700">{goal.percentage}%</span>
                  ...
                  <td className="px-4 py-3 align-top text-right">
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-full border border-slate-200 px-3 py-1 text-xs font-semibold text-slate-600 transition hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700"
                    >
                      Ver
