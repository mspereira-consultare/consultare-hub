...
export async function GET() {
  try {
    ...
    worksheet.getCell('A1').value = 'Portfólio consolidado global de tarefas';
    ...
    worksheet.getCell('A2').value = 'Exportação consolidada dos projetos e tarefas avulsas visíveis pela governança.';
    ...
    const filename = `portfolio-consolidado-governanca-${slugify(new Date().toISOString().slice(0, 10))}.xlsx`;
    ...
    console.error('Erro ao exportar portfólio gantt do painel em XLSX:', error);
