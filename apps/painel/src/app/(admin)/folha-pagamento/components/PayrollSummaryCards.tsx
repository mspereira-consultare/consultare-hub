        ...
        return (
          <div key={card.key} className={`rounded-xl border ${toneClass} px-4 py-3 shadow-sm`}>
            <div className="flex items-start justify-between gap-3">
              <div>
                <div className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">{card.title}</div>
                <div className="mt-2 text-[1.4rem] font-bold leading-none text-slate-900">{value}</div>
