...
export function PostConsultDetailTable({ rows, canEdit, onSaved }: Props) {
  return (
    <div className="max-h-[72vh] overflow-auto rounded-xl border border-slate-200">
      <table className="w-full min-w-[2320px] bg-white text-left">
        <thead className="sticky top-0 z-10 bg-slate-50 text-[11px] font-semibold uppercase tracking-wider text-slate-500">
          <tr>
            ...
            <th className="px-4 py-3">Atendente responsável</th>
            <th className="px-4 py-3">Consulta</th>
            <th className="px-4 py-3">Proposta</th>
            <th className="px-4 py-3">Status da proposta</th>
            <th className="px-4 py-3">Pós-consulta fechou?</th>
            <th className="px-4 py-3">Data/hora do contato</th>
            <th className="px-4 py-3">2º contato fechou?</th>
            <th className="px-4 py-3">Data/hora da ligação</th>
