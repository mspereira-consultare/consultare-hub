...
const WIDGETS: WidgetSeed[] = [
  ...
  { key: 'tempo_empresa_um_ano', label: 'Tempo de empresa - 1 ano', areaKey: 'pessoas', status: 'available', sourceKey: 'employees.dashboard', description: 'Marcos de permanência e alertas de 1 ano.' },
  ...
  { key: 'agendamento_diario_meta', label: 'Agendamento diário x meta', areaKey: 'operacao', status: 'available', sourceKey: 'goals.dashboard', description: 'Acompanhamento diário de agendamento contra meta.' },
  { key: 'agendamento_mensal_meta', label: 'Agendamento mensal x meta', areaKey: 'operacao', status: 'available', sourceKey: 'goals.dashboard', description: 'Acompanhamento mensal de agendamento contra meta.' },
