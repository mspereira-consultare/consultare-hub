...
const WIDGETS: WidgetSeed[] = [
  ...
  { key: 'aniversariantes_dia', label: 'Aniversariantes do dia', areaKey: 'pessoas', status: 'planned', sourceKey: 'employees.dashboard', description: 'Colaboradores aniversariantes no período.' },
  ...
  { key: 'ocupacao_agendas', label: 'Ocupação das agendas', areaKey: 'operacao', status: 'planned', sourceKey: 'agenda_occupancy', description: 'Indicadores de ocupação das agendas por recorte.' },
  { key: 'confirmacao_agendas', label: 'Confirmação das agendas', areaKey: 'operacao', status: 'planned', sourceKey: 'agendamentos', description: 'Taxa e volume de confirmações de agenda.' },
  ...
  { key: 'mapa_semanal_agendas', label: 'Mapa semanal das agendas', areaKey: 'operacao', status: 'planned', sourceKey: 'agenda_occupancy', description: 'Distribuição semanal das agendas.' },
  { key: 'google', label: 'Google', areaKey: 'comercial', status: 'planned', sourceKey: 'marketing.funil', description: 'Indicadores consolidados de Google e origem digital.' },
  ...
  { key: 'faturamento_campanha_conversao', label: 'Faturamento x meta x campanha x conversão', areaKey: 'comercial', status: 'planned', sourceKey: 'marketing.controle', description: 'Relação entre faturamento, mídia e conversão.' },
  ...
  { key: 'mapa_diario_agendas', label: 'Mapa diário das agendas', areaKey: 'operacao', status: 'planned', sourceKey: 'agenda_occupancy', description: 'Distribuição diária das agendas.' },
  ...
  { key: 'investimento_ads', label: 'Investimento ADS', areaKey: 'comercial', status: 'planned', sourceKey: 'marketing.controle', description: 'Investimento consolidado em mídia paga.' },
